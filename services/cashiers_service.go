...
func Get(c *cashiers.Cashier) rest_errors.RestErr {
	return c.GetById();
}


func List() (cashiers.Cashiers, rest_errors.RestErr) {

	temp := cashiers.Cashier{}


	return temp.GetList(0, 0)
}

func Create(c  *cashiers.Cashier) rest_errors.RestErr {
	return c.Create()
}
